...
//==========================================Functions========================================//
	...
	function orderSearch()
		...
		if(($_SESSION['orderSearchType'] == 'dateRange') and (isset($_SESSION['date1'])) and (isset($_SESSION['date2'])))
			...
			$sql = "SELECT * FROM " . $GLOBALS['dbOrders'] . " WHERE " . $GLOBALS['dbDate'] . " BETWEEN '" . $_SESSION['date1'] . "' AND '" . $_SESSION['date2'] . "';";
		...
		if(($_SESSION['orderSearchType'] == 'status') and ($_SESSION['parmsStatus'] != 'false'))
			...
			//Creates and runs query
			$sql = "SELECT * FROM " . $GLOBALS['dbOrders'] . " WHERE " . $GLOBALS['dbStatus'] . " = '" . $_SESSION['parmsStatus'] . "';";
			$result = $pdo->query($sql);
			$result = $result->fetchAll();
		...
		if(($_SESSION['orderSearchType'] == 'priceRange') and (isset($_SESSION['price1'])) and (isset($_SESSION['price2'])))
			...
			//Creates and runs query
			$sql = "SELECT * FROM " . $GLOBALS['dbOrders'] . " WHERE " . $GLOBALS['dbPrice'] . " BETWEEN '" . $_SESSION['price1'] . "' AND '" . $_SESSION['price2'] . "';";
			$result = $pdo->query($sql);
			$result = $result->fetchAll();
